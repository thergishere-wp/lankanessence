...
import WhySriLanka from '@/components/sections/WhySriLanka'
import SectionLabel from '@/components/ui/SectionLabel'
import JungleDivider from '@/components/layout/JungleDivider'
...
export default function HomePage() {
  return (
    <main>
      ...
      <JungleDivider fromColor="#0D2818" toColor="#F5F0E8" />
